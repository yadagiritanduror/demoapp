...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post softwares_url, params: { software: { category: @software.category, industry: @software.industry, name: @software.name, type: @software.type } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { category: @software.category, industry: @software.industry, name: @software.name, type: @software.type } }
